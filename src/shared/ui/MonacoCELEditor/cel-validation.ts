 ...
 * check is always made *for a context*: `alerts` filters run as SQL, while
 * `maintenance` conditions are evaluated in-process by the event handler.
 */
export type CelValidationContext = "alerts" | "maintenance";
