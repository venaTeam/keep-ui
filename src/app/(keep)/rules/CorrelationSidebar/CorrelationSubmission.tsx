  ...
  return (
    <div className="xl:col-span-2 flex justify-between items-end">
      <div className="flex items-center gap-x-4">
        <Button type="button" variant="light" color="orange" onClick={toggle} data-cy="rules-form-cancel-btn">
          Cancel
        </Button>
        <Button color="orange" disabled={!isValid || exceeds90Days} data-cy="rules-form-submit-btn">
